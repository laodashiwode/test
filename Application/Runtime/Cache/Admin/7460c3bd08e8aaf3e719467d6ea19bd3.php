                    ...
                    <div class="col-md-12">
                        ...
                        <div class="widget">
                            ...
                            <div class="widget-head">
                                <div class="pull-left"><a href="/index.php/Admin/Goods/add"><button type="button" class="btn btn-danger">添加商品</button></a></div>
                            ...
                            <div class="widget-content">
                                ...
                                <table class="table table-striped table-bordered table-hover">
                                    ...
                                    <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                                            ...
                                            <td><img src="/Uploads//<?php echo ($vo["face_img"]); ?>" alt="" width="100" height="100"></td>
                                            <td>
                                                <!--<button class="btn btn-xs btn-success"><i class="icon-ok"></i></button>-->
                                                <a href="/index.php/Admin/Goods/edit/id/<?php echo ($vo["good_id"]); ?>"><button class="btn btn-xs btn-warning"><i class="icon-pencil"></i></button></a>
                                                <a href="/index.php/Admin/Goods/gooddel/id/<?php echo ($vo["good_id"]); ?>" onClick="return confirm('确认删除吗？')"><button class="btn btn-xs btn-danger"><i class="icon-remove"></i></button></a>
                                                </button>
