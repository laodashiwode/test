    ...
    <ul id="nav">
        ...
        <li class="has_sub"><a href="#"><i class="icon-list-alt"></i> 商品管理  <span class="pull-right"><i class="icon-chevron-right"></i></span></a>
            <ul>
                ...
                <li><a href="/index.php/Admin/Goods/add">商品添加</a></li>
                            ...
                            <div class="widget-content">
                                <div class="padd">
                                    ...
                                    <form class="form-horizontal" id="formid" role="form" method="post"
                                          onsubmit="checkUser();" action="/index.php/Admin/Goodtype/handle" enctype='multipart/form-data'>
                                        <div class="form-group">
                                            <label class="col-lg-4 control-label">分类名称</label>
                                            <div class="col-lg-8">
                                                <input type="text" class="form-control" id="title" name="type_name"
                                                       placeholder="分类名称" value="<?php echo ($info["type_name"]); ?>">
                                                <input type="hidden" name="type_id" value="<?php echo ($info["type_id"]); ?>">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="col-lg-4 control-label">排序ID</label>
                                            <div class="col-lg-8">
                                                <input type="text" class="form-control" id="orderby_id" name="orderby_id"
                                                       placeholder="排序ID" value="<?php echo ($info["orderby_id"]); ?>">
                                            </div>
                                        </div>
                                        <hr/>
                                        <div class="form-group">
