                    ...
                    <div class="col-md-12">
                        ...
                        <div class="widget">
                            ...
                            <div class="widget-head">
                                <div class="pull-left"><a href="/index.php/Admin/Goodtype/add"><button type="button" class="btn btn-danger">添加商品分类</button></a></div>
                            ...
                            <div class="widget-content">
                                ...
                                <table class="table table-striped table-bordered table-hover">
                                    ...
                                    <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                                            ...
                                            <td><?php echo ($vo["orderby_id"]); ?></td>
                                            <td>
                                                <!--<button class="btn btn-xs btn-success"><i class="icon-ok"></i></button>-->
                                                <a href="/index.php/Admin/Goodtype/edit/id/<?php echo ($vo["type_id"]); ?>"><button class="btn btn-xs btn-warning"><i class="icon-pencil"></i></button></a>
                                                <a href="/index.php/Admin/Goodtype/gooddel/id/<?php echo ($vo["type_id"]); ?>" onClick="return confirm('确认删除吗？')"><button class="btn btn-xs btn-danger"><i class="icon-remove"></i></button></a>
